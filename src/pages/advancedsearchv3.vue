<template>
    <div>
    <!-- DOC TYPE MODAL!!! -->
        <md-dialog :md-active.sync="docTypeModal" class="docTypes">
            <md-dialog-title>Document types</md-dialog-title>
            <md-dialog-content>
                <p style="margin:0px 0px 16px 0px;">
                    Please select the all of the document types you're looking for
                    <div class="modalWrapper">
                        <DocTypesFilter :docTypesSelected.sync="this.docTypesSelected"></DocTypesFilter>
                    </div>
    
                    <md-dialog-actions style="margin-top: 16px;">
                        <md-button class="md-raised" @click="docTypeModal = false;" style="margin-right: 8px;">Close</md-button>
                        <md-button class="md-primary md-raised" @click="docTypeModal = false; formatDocTypeData()">Save</md-button>
                    </md-dialog-actions>
            </md-dialog-content>
        </md-dialog>
        ...
        <md-toolbar md-elevation="0" class="secondaryToolbar" style="z-index: 0;">
            <h3 class="md-headline">Advanced search V3</h3>
                    ...
                    <div class="md-layout md-gutter">
                        <div class="md-layout-item">
                            <md-field>
                                ...
                                <div class="md-helper-text">Click on the icon to filter document types</div>
                                <md-textarea v-model="formattedDocTypes" md-autogrow>Label</md-textarea>
                                <md-button class="md-icon-button" @click="docTypeModal = true">
                                    <md-icon v-if="formattedDocTypes == ''">filter_list</md-icon>
                                    <md-icon v-if="formattedDocTypes !== ''">edit</md-icon>
                                </md-button>
                            </md-field>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            formatDocTypeData() {
                this.formattedDocTypes = this.docTypesSelected.join(", ");
            }
        }
    };
</script>
